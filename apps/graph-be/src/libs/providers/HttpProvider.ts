...
import { AgentController } from 'src/rests/controllers/AgentController';
import { DeployController } from 'src/rests/controllers/DeployController';
import { EdgeController } from 'src/rests/controllers/EdgeController';
import { PackageController } from 'src/rests/controllers/PackageController';
import { SubgraphController } from 'src/rests/controllers/SubgraphController';
...
export default class HttpProvider extends Provider {
  ...
  async boot(): Promise<void> {
    ...
    useExpressServer(this.expressApp, {
      ...
      controllers: [AgentController, DeployController, EdgeController, PackageController, SubgraphController],
      middlewares: [
