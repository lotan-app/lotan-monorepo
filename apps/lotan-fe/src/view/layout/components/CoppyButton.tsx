...
const CopyToClipboardComp: any = CopyToClipboard;
const CopyButton: FC<ICopyButton> = ({ content, style, color, placement }) => {
  ...
  return (
    <CopyToClipboardComp text={content}>
      <div className={styles.main} onClick={() => !success && showSuccess()} style={style} onMouseOver={_onMouseEnter}>
        <OverlayTrigger
          show={success}
          overlay={
            <Tooltip>
