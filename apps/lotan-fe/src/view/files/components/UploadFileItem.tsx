...
import { cancelUploadFile, changeUploadItem, deleteUploadFile, uploadNewFile } from '@App/services/files/fileService';
...
const UploadFileItem: FC<IUploadItemProps> = ({
  ...
  const reloadFile = () => {
    ...
    dispatch(uploadNewFile([uploadItem]));
  };
      ...
      <div className={styles.left}>
        ...
        <div className={styles.info}>
          <Text size={16} color="neutral-n10" manyLines={false}>
            {truncateMiddleText(name, '...', width < 767 || isMinify ? 6 : 8, width < 767 || isMinify ? 6 : 8)}
          </Text>
              ...
              {!isResume && (
                <>
                  ...
                  <div className={styles.progress_text}>
                    ...
                    <Text color="neutral-n7">{status === STATUS_FILE_UPLOAD.FINISH ? 'Uploaded' : 'Uploading...'}</Text>
                  </div>
                </>
              )}
            </>
      ...
      <div className={styles.right}>
        {(status === STATUS_FILE_UPLOAD.FAIL || isResume) && (
          <>
            ...
            <div className={styles.icon} onClick={() => dispatch(deleteUploadFile(id))}>
